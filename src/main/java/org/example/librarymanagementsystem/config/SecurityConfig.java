...
import org.example.librarymanagementsystem.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // allow both ADMIN and LIBRARIAN to create books
                        .requestMatchers(HttpMethod.POST,   "/api/books").hasAnyRole("ADMIN","LIBRARIAN")
                        // still only ADMIN for updates/deletes
